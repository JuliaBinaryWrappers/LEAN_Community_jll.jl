...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LEAN_Community_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("def0f3ea-0521-5e8c-a7b7-92f0f4873a26"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LEAN_Community", artifacts_toml) for e in artifacts["LEAN_Community"]]
...
if best_platform === nothing
    @debug("Unable to load LEAN_Community; unsupported platform $(triplet(platform_key_abi()))")
else
